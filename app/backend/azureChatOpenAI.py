...
def human_chatml(self) -> str:
    return f"<|im_start|>user\n{self.content}\n<|im_end|>"
def ai_chatml(self) -> str:
        return f"<|im_start|>assistant\n{self.content}\n<|im_end|>"
def system_chatml(self) -> str:
    return f"<|im_start|>system\n{self.content}\n<|im_end|>"
def chat_chatml(self) -> str:
    return f"<|im_start|>{self.role}\n{self.content}\n<|im_end|>"

BaseMessage.format_chatml = format_chatml
HumanMessage.format_chatml = human_chatml
AIMessage.format_chatml = ai_chatml
SystemMessage.format_chatml = system_chatml
ChatMessage.format_chatml = chat_chatml
